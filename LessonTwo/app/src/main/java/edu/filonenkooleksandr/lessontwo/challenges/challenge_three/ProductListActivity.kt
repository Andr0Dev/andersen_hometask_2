...
import edu.filonenkooleksandr.lessontwo.challenges.challenge_two.ChoiceActivity
import edu.filonenkooleksandr.lessontwo.databinding.ActivityProductListBinding
...
class ProductListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.findShop.setOnClickListener {
            val location = viewBinding.shop?.text.toString()
